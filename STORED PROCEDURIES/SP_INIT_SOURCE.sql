...
BEGIN
	...
	INSERT INTO T_SOURCE([TYPE_ID],[SUM],[SUM1],[SUM2],[SUM3],[SUM4],[FLAG],[FLAG1],[FLAG2],[STR],[STR1],[STR2]) 
	VALUES(15,2.24,1563.25,4.65,373.54,2.88,0,1,1,'50943','Machynlleth','Wynter, Amela, Hayes, Gloria'),
	...
	INSERT INTO T_SOURCE([TYPE_ID],[SUM],[SUM1],[SUM2],[SUM3],[SUM4],[FLAG],[FLAG1],[FLAG2],[STR],[STR1],[STR2]) 
	VALUES(62,89.40,3255.81,7.20,609.40,8.77,1,1,1,'99901','Samarinda','Paula, Darrel, Ethan, Ali'),
	...
	INSERT INTO T_SOURCE([TYPE_ID],[SUM],[SUM1],[SUM2],[SUM3],[SUM4],[FLAG],[FLAG1],[FLAG2],[STR],[STR1],[STR2]) 
	VALUES(45,96.26,4910.72,3.67,749.78,3.53,1,1,0,'53813','Hyderabad','Guinevere, Violet, Mannix, Walker'),
	...
	INSERT INTO T_SOURCE([TYPE_ID],[SUM],[SUM1],[SUM2],[SUM3],[SUM4],[FLAG],[FLAG1],[FLAG2],[STR],[STR1],[STR2]) 
	VALUES(76,80.03,8176.36,8.82,538.58,5.11,0,1,1,'09078','New Haven','Geraldine, Geoffrey, Wing, Violet'),
